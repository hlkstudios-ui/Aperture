...
export default async function MyListPage() {
  ...
  return <main className="catalog-page"><SiteHeader /><section className="catalog-intro"><p className="eyebrow">Private to this profile</p><h1>My List</h1><p>Saved movies and series, kept separate from {brand.short_name}&apos;s editorial collections.</p></section>
